...
// ============================================================
// 2. FUNÇÕES GLOBAIS (ADMIN & CANCELAMENTO)
// ============================================================
...
window.initAdmin = function() {
    ...
    // Tenta carregar as funções se existirem na janela
...
// ============================================================
// 3. EVENT LISTENER PRINCIPAL (PÁGINAS)
// ============================================================
document.addEventListener('DOMContentLoaded', () => {
    
    // --- VARIÁVEIS COMPARTILHADAS (CORREÇÃO DE ESCOPO) ---
    ...
    if (btnBuscar) {
        ...
        // Lógica de Horários (FUNÇÕES INTERNAS PARA USAR VARIÁVEIS COMPARTILHADAS)
            ...
            for (let m = menorInicio; m <= maiorFim - duracao; m += 30) {
                ...
                if (livres.length > 0) {
                    ...
                    btn.onclick = () => {
                        ...
                        if (livres.length === 1) {
                            selecionarProfissional(livres[0].nome);
                        } else {
        ...
        // Funções internas para usar o escopo compartilhado
        window.mostrarModalProfissionais = function(lista) {
        ...
        window.selecionarProfissional = function(nome) {
        ...
        if(btnConfirma) {
            btnConfirma.addEventListener('click', async () => {
                // AGORA ESSAS VARIÁVEIS ESTÃO ACESSÍVEIS!
